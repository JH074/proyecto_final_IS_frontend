      ...
      <div className="w-full bg-white rounded-xl p-6 space-y-6">
        ...
        <section>
          ...
          {totalPendientes > 1 && (
            <div className="flex justify-center items-center gap-4 mt-4">
              <button
                onClick={() => setPagePendientes(p => Math.max(p - 1, 1))}
              ...
              <button
                onClick={() => setPagePendientes(p => Math.min(p + 1, totalPendientes))}
        ...
        <section>
          ...
          {totalRealizadas > 1 && (
            <div className="flex justify-center items-center gap-4 mt-4">
              <button
                onClick={() => setPageRealizadas(p => Math.max(p - 1, 1))}
              ...
              <button
                onClick={() => setPageRealizadas(p => Math.min(p + 1, totalRealizadas))}
